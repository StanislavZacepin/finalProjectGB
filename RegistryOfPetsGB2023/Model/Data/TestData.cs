...
namespace RegistryOfPetsGB2023.Model.Data
{
    public static class TestData
    {
        ...
        private static Donkey donkey = new Donkey { id = 4, Age = 1, Name = "Лала", Description = "парам пам пам" };
        private static Horse horse = new Horse { id = 5, Age = 1, Name = "Пегас", Description = "парам пам пам" };
        private static Camel camel = new Camel { id = 6, Age = 1, Name = "Джо", Description = "парам пам пам" };
        #endregion
        ...
        public static ObservableCollection<IAnimal> animals { get; set; } = new ObservableCollection<IAnimal>() { dogs, cats, hamster, donkey, horse, camel };
